...
class _BookassetpageState extends State<BookassetApprover> {
  ...
  void initState() {
    super.initState();
    category = widget.category ?? "All"; // รับค่า category จาก HomeUser
    fetchAssets(); // ดึงข้อมูล assets
  }
  ...
  Future<void> fetchAssets() async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse('http://10.0.1.239:3000/approver/asset'),
        headers: {
          'Authorization': ' $token',
              ...
              itemBuilder: (context, index) {
                ...
                return AssetCard(
                    ...
                    onTap: () {
                      ...
                      if (asset['status_movie'] == 3) {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => RequestApprover(
                      ...
                      onPressed: () async {
                        ...
                        try {
                          ...
                          final response = await http.post(
                            //=================เปลี่ยน ip=========================================
                            Uri.parse(
                                'http://10.0.1.239:3000/borrow/$borrowerId'),
                            headers: {
                              'Authorization': ' $token',
                              'Content-Type': 'application/json',
                            },
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          // เว้นระยะห่างระหว่างไอคอนและข้อความ
                          Text(
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          SizedBox(width: 8),
                          Text(
                            'BOOK ID: ${asset['movie_id'] ?? 'Unknown'}',
                            style: TextStyle(
                              fontSize: 13,
                              color: Colors.grey.shade600,
                            ),
                      ...
                      _buildStatusButton(asset['status_movie']),
